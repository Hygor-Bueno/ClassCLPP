...
export class GeneralModal {
    ...
    main(message, controller) {
        document.getElementById('StyleModal').setAttribute('href',"./Components/generalModal/modal_geral.css");
        ...
        let response =
        `   <div class="${controller ? "modalERR" : "modalCONF"}">
                <header>
                    ${controller ? svgAlertError : svgAlertConfirm}<h1 class="title_alert">ATENÇÃO !</h1>
